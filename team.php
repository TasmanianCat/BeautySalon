...
<body>
  ...
  <main class="main">
    <div class="main-content container">
      <h2><?php echo $nav_links[1]["title"]; ?></h2>
      <div class="content-wrapper">
        <p>Наша команда опытных профессионалов стремится предоставлять высококачественные услуги по уходу за внешностью и уходу за собой. Благодаря многолетнему опыту в парикмахерском деле, маникюре и дизайне ногтей мы гарантируем, что каждый клиент получит исключительный уход и последние тенденции в области красоты.</p>
        <p>Эксперты по волосам — от стильных повседневных стрижек до элегантных свадебных причесок и профессионального окрашивания волос — наши опытные парикмахеры привносят креативность и точность в каждый прием. Будь то мужская, женская или детская стрижка, мы адаптируем каждую услугу в соответствии с вашим уникальным стилем.</p>
        <p>Специалисты по ногтям — имея большой опыт в аппаратном маникюре, нанесении гель-лака и креативном дизайне ногтей, наши талантливые специалисты по ногтям здесь, чтобы придать вашим рукам безупречный и модный вид.</p>
        <p>В нашем салоне мы объединяем страсть, мастерство и новейшие методики, чтобы помочь вам выглядеть и чувствовать себя наилучшим образом!</p>
        ...
        <div class="team-members">
          ...
          ?>
            <div class="team-member">
              <div class="team-member-photograph">
                <img src="./assets/img/avatars/<?php echo $team_member["photograph"]; ?>" alt="<?php echo $team_member["name"]; ?>">
              </div>
              <h3><?php echo $team_member["name"]; ?></h3>
              <p><?php echo $team_member["experience"]; ?></p>
            </div>
            <!-- Social Medea Icons -->
